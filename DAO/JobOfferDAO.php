<?php
    ...
    class JobOfferDAO
    {
        ...
        public function Add(JobOffer $jobOffer)
        {
            try
            {
                $query = "INSERT INTO ".$this->tableName." (jobOfferId,description,publicationDate,expirationDate,requirements,workload,jobPositionId,companyId,active) 
                VALUES (:jobOfferId,:description,:publicationDate,:expirationDate,:requirements,:workload,:jobPositionId,:companyId,:active);";
        ...
        public function Modify(JobOffer $jobOffer)
        {
            try
            {
                ...
                $query = "UPDATE ".$this->tableName." SET description=:description,publicationDate=:publicationDate,expirationDate=:expirationDate,requirements=:requirements,workload=:workload,jobPositionId=:jobPositionId,companyId=:companyId,active=:active
        ...
        {   
            ...
            {
                return new JobOffer($p['jobOfferId'],$p['description'],$p['publicationDate'],$p['expirationDate'],$p['requirements'],$p['workload'],$p['jobPositionId'],$p['companyId'],$p['active']);
            }, $jobOffers);
